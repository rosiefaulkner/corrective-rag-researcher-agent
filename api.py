"""FastAPI application for the CRAG Research Agent."""
...
async def root():
    """Root endpoint."""
    return {
        "message": "CRAG Research Agent API",
        "version": "1.0.0",
        "endpoints": {
...
async def invoke_agent(request: AgentRequest) -> AgentResponse:
    """
    Invoke the CRAG research agent with a query.
